...
import JarvisRobot.modules.sql.global_bans_sql as gban_sql
import JarvisRobot.modules.sql.users_sql as user_sql
from JarvisRobot import DEV_USERS, OWNER_ID, dispatcher
