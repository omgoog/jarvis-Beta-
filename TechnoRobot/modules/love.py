...
import TechnoRobot.modules.love_strings as love_strings
...
__help__ = """
 ...
 • `/flirt`*:* Techno will flirt to the replied person or with you
 • `/lewd`*:* Techno will act lewd with you or with the replied person
